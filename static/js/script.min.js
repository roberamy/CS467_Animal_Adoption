...
!(function (s) {
            ...
            s(".sp-loading").hide(),
                s(".sp-wrap").each(function () {
                    if ((s(this).addClass("sp-touch"), s("a", this).length > 1)) {
                        var e,
                            t,
                            a = !!s("a.sp-default", this)[0];
                        s(this).append('<div class="sp-large"></div><div class="sp-thumbs sp-tb-active"></div>'),
                            s("a", this).each(function (p) {
                                var n = s("img", this).attr("src"),
                                    i = s(this).attr("href"),
                                    r = "";
                                ((0 === p && !a) || s(this).hasClass("sp-default")) && ((r = ' class="sp-current"'), (e = i), (t = s("img", this)[0].src)),
                                    s(this)
                                        .parents(".sp-wrap")
                                        .find(".sp-thumbs")
                                        .append('<a href="' + i + '" style="background-image:url(' + n + ')"' + r + "></a>"),
                                    s(this).remove();
                            }),
                            s(".sp-large", this).append('<a href="' + e + '" class="sp-current-big"><img src="' + t + '" alt="" /></a>'),
                ...
                s(document.body).on("click", ".sp-tb-active a", function (e) {
                    e.preventDefault(),
                        ...
                        s(this).parents(".sp-wrap").find(".sp-thumbs").removeClass("sp-tb-active"),
                    ...
                    s(this)
                        .parents(".sp-wrap")
                        .find(".sp-large")
                        .css({ overflow: "hidden", height: a + "px", width: p + "px" }),
                    ...
                    s(this)
                        .parents(".sp-wrap")
                        .find(".sp-large")
                        .html('<a href="' + n + '" class="sp-current-big"><img src="' + i + '"/></a>'),
                        s(this)
                            .parents(".sp-wrap")
                            .find(".sp-large")
                            .hide()
                            .fadeIn(250, function () {
                                ...
                                s(this)
                                    .parents(".sp-wrap")
                                    .find(".sp-large")
                                    .animate({ height: e }, "fast", function () {
                ...
                s(document.body).on("click", ".sp-non-touch .sp-zoom", function (e) {
                    ...
                    s(this).parents(".sp-wrap").addClass("sp-selected"),
                        s("body").append("<div class='sp-lightbox' data-currenteq='" + p + "'>" + t + "</div>"),
                        a > 1 && (s(".sp-lightbox").append("<a href='#' id='sp-prev'></a><a href='#' id='sp-next'></a>"), 1 == p ? s("#sp-prev").css("opacity", ".1") : p == a && s("#sp-next").css("opacity", ".1")),
                ...
                s(document.body).on("click", ".sp-large a", function (e) {
                    var t = s(this).attr("href"),
                        ...
                        p = s(this).parents(".sp-wrap").find(".sp-thumbs .sp-current").index() + 1;
                    s(this).parents(".sp-wrap").addClass("sp-selected"),
                        s("body").append('<div class="sp-lightbox" data-currenteq="' + p + '"><img src="' + t + '"/></div>'),
                        a > 1 && (s(".sp-lightbox").append("<a href='#' id='sp-prev'></a><a href='#' id='sp-next'></a>"), 1 == p ? s("#sp-prev").css("opacity", ".1") : p == a && s("#sp-next").css("opacity", ".1")),
                        s(".sp-lightbox").fadeIn(),
                        e.preventDefault();
                }),
                s(document.body).on("click", "#sp-next", function (e) {
                    ...
                    if (a >= p);
                        ...
                        a == p - 1 && s("#sp-next").css("opacity", ".1"),
                            s("#sp-prev").css("opacity", "1"),
                            s(".sp-selected .sp-current").removeClass(),
                            s(".sp-selected .sp-thumbs a:eq(" + a + ")").addClass("sp-current"),
                            s(".sp-selected .sp-large")
                                .empty()
                                .append("<a href=" + i + '><img src="' + r + '"/></a>'),
    ...
    $(".clean-gallery").length > 0 && baguetteBox.run(".clean-gallery", { animation: "slideIn" }),
    $(".clean-product").length > 0 &&
